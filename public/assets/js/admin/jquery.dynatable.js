...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationLinkClass: 'page-link',
      paginationPrevClass: 'page-prev',
      paginationNextClass: 'page-next',
      paginationActiveClass: 'active-page',
      paginationDisabledClass: 'disabled-page',
