...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Possession_status" name="possession_status" required>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <p class="help-block">Press ctrl button for multiple image</p>
</div>
<div class="checkbox">
    <label>
