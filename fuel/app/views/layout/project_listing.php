                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    ...
                                    <img class="fit-image" src="<?php echo Uri::base(false);?>assets/img/demo-content/listing8.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="<?php echo Uri::base(false);?>assets/img/demo-content/listing8.jpg" data-lightbox="related-4">
                                                <i class="fa fa-camera"></i>
                                            </a>
                                        </div>
                                        <div class="right">
                                            <a class="inner" href="<?php echo Uri::base(false);?>welcome/newproject">
