<div class="col-md-8">
                <div class="breadcrumbs">
                    <ol class="breadcrumb text-right">
                        <li><a href="index-2.html">Home</a></li><li class="active">Portfolio 2 Columns</li>
                    </ol>
                </div>
                <section>
                    <div class="title">
                        Properties portfolio - 2 columns
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    ...
                                    <img class="fit-image" src="assets/images/demo-content/listing8.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="assets/images/demo-content/listing8.jpg" data-lightbox="related-4">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    <span class="listing-tag important">For Sale</span>
                                    <img class="fit-image" src="assets/images/demo-content/listing10.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="assets/images/demo-content/listing10.jpg" data-lightbox="related-5">
                                                <i class="fa fa-camera"></i>
                                            </a>
                                        </div>
                                        <div class="right">
                                ...
                                <div class="caption">
                                    <h4>The Fabulous Bird House<br>
                                        <small>Spain, Mallorca</small></h4>

                                    <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.</p>                                </div>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    <span class="listing-tag important">For Sale</span>
                                    <img class="fit-image" src="assets/images/demo-content/listing12.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="assets/images/demo-content/listing12.jpg" data-lightbox="related-2">
                                                <i class="fa fa-camera"></i>
                                            </a>
                                        </div>
                                        <div class="right">
                                ...
                                <div class="caption">
                                    <h4>The Deck House<br>
                                        <small>Malaysia, Pahang</small></h4>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    <span class="listing-tag important">For Sale</span>
                                    <img class="fit-image" src="assets/images/demo-content/listing11.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="assets/images/demo-content/listing11.jpg" data-lightbox="related-2">
                                                <i class="fa fa-camera"></i>
                                            </a>
                                        </div>
                                        <div class="right">
                                ...
                                <div class="caption">
                                    <h4>Blue Dreaming Villa<br>
                                        <small>Italy, Tuscan</small></h4>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    <span class="listing-tag important">For Sale</span>
                                    <img class="fit-image" src="assets/images/demo-content/listing2.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                ...
                                <div class="caption">
                                    <h4>Quartz Mountain<br>
                                        <small>Arizona, Paradise Valley</small></h4>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="thumbnail clean">
                                <div class="listing-image">
                                    <span class="listing-tag important">For Sale</span>
                                    <img class="fit-image" src="assets/images/demo-content/listing3.jpg" alt="Listing">
                                    <div class="image-links">
                                        <div class="left">
                                            <a class="inner" href="assets/images/demo-content/listing3.jpg" data-lightbox="related-2">
                                                <i class="fa fa-camera"></i>
                                            </a>
                                        </div>
                                        <div class="right">
