<div class="col-md-8">
                <div class="breadcrumbs">
                    <ol class="breadcrumb text-right">
                        <li><a href="index-2.html">Home</a></li><li class="active">Portfolio 1 Column</li>
                    </ol>
                </div>
                <section>
                    <div class="title">
                        Properties portfolio - 1 column
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="thumbnail clean">
                                    ...
                                    <div class="table-row pull-right">
                                        <div class="table-cell">
                                            <span class="price-tag important"><strong>$1.450.000</strong></span>
                                        </div>
                                        <div class="table-cell">
                                            <a href="#" class="btn btn-link large-padding" role="button">+ Show Details</a>
                                        </div>
                                    </div>
                                    <br>
                                    <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="thumbnail clean">
                                    <div class="listing-image">
                                        <span class="listing-tag important">For Sale</span>
                                        <img class="fit-image" src="assets/images/demo-content/listing4.jpg" alt="Listing">
                                        <div class="image-links">
                                            <div class="left">
                                                <a class="inner" href="assets/images/demo-content/listing4.jpg" data-lightbox="related-2">
                                                    <i class="fa fa-camera"></i>
                                                </a>
                                            </div>
                                            <div class="right">
                                    ...
                                    <div class="caption">
                                        <h4>Mill Walley Residence<br>
                                            <small>USA, Marcin, California</small></h4>
